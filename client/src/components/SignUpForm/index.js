...
export function SignInLink(props) {
    ...
    export function GoogleBtn(props) {
        return (
            <div className="input-field col s12">
                <button type="submit" className="btn" ><a href="/api/user/auth/google">Sign In with Google</a></button>
                {props.children}
            </div>
        );
    }
        ...
        export function FacebookBtn(props) {
            return (
                <div className="input-field col s12">
                    <button onClick={props.onClick} type="submit" className="btn"><a href="/api/user/auth/facebook">Login with Facebook</a></button>
                    {props.children}
                </div>
            );
}
...
<li>
<p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named phone-eats-first</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to phone-eats-first.</p>
</li>
<li>
